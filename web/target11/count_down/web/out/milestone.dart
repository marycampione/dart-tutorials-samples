...
class Milestone extends Observable  {
  ...
  dynamic get dbKey {
    if (__observe.observeReads) {
      __observe.notifyRead(this, __observe.ChangeRecord.FIELD, 'dbKey');
    }
    return __$dbKey;
  }
  set dbKey(dynamic value) {
    if (__observe.hasObservers(this)) {
      __observe.notifyChange(this, __observe.ChangeRecord.FIELD, 'dbKey',
          __$dbKey, value);
    }
    __$dbKey = value;
  }
  
  Duration __$timeRemaining = new Duration();
...
//# sourceMappingURL=milestone.dart.map